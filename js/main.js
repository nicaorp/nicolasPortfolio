...
ScrollReveal().reveal('.home .info h3, .home .info p, .about-info .btn', { delay: 300, origin: 'left' });
...
ScrollReveal().reveal('.about .description, .contact-right', { delay: 400, origin: 'left' });
ScrollReveal().reveal('.about .professional-list li', { delay: 300, origin: 'left', interval:200 });
